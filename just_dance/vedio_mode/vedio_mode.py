...
import time
from just_dance.vedio_mode.gui import VedioModeWindow
from just_dance.vedio_mode.vedio_score_page import ScoreDisplay
...
class VedioModePage:
    def __init__(self, root):
        self.root = root
        self.main_window = VedioModeWindow(
            root,
